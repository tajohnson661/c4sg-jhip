...
class LocationGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Location entity")
        ...
        .repeat(2) {
            ...
            .post("/api/locations")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "streetAddress1":"SAMPLE_TEXT", "streetAddress2":"SAMPLE_TEXT", "city":"SAMPLE_TEXT", "stateProvince":"SAMPLE_TEXT", "postalCode":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))

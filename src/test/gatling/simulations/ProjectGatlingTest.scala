...
class ProjectGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Project entity")
        ...
        .repeat(2) {
            ...
            .post("/api/projects")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "image":"SAMPLE_TEXT", "remote":"SAMPLE_TEXT", "contactName":"SAMPLE_TEXT", "contactPhone":"SAMPLE_TEXT", "contactEmail":"SAMPLE_TEXT", "status":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
